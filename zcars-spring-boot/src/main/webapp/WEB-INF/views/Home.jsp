                    ...
                    <div class="box">
                        ...
                        <div class="text">
                            <a href="">
                                ...
                                <p>
Apply online with a valid driver's license. Most people are approved instantly and can book a trip within minutes.</p>
                            </a>
                        </div>
                    </div>
                    <div class="box">
                        ...
                        <div class="text">
                            <a href="">
                                <h3>Drive on demand</h3>
                                <p>
Book a round trip car by the day. Use our car sharing ZCar app to unlock and lock during your trip. We'll also send you a ZCard.</p>
                            </a>
                        </div>
                    </div>
                    <div class="box">
                        ...
                        <div class="text">
                            <a href="">
                                <h3>Return</h3>
                                <p>
When you're done, park the car in the same location you picked it up from, then end the trip with the app.</p>
                            </a>
                        </div>
                    </div>
                </section>
