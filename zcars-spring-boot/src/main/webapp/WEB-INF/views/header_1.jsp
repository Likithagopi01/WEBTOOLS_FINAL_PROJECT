    ...
    <body>
        <header>
            <div>
                ...
                <p class="title">ZCARS</p>
            </div>
            <nav>
                <ul>
                    <li><a href="http://localhost:8080/zcars/home">Home</a></li>
                    <!--                    <li><a href="about.html">About</a></li>
                                        <li><a href="travel.html">Travel</a></li>-->
                    <li><a href="http://localhost:8080/zcars/user/login">Sign In</a></li>
                    <li><a href="http://localhost:8080/zcars/user/register">Register</a></li>
                </ul>
            </nav>
        </header>
    </body>
